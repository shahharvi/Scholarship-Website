...
@endif
  ...
  <main id="main" class="main">
    ...
    <div class="main-content">
        ...
        <form action="{{ route('admin.addscholarship') }}" method="POST">
        @csrf

        <div class="form-group">
            <label for="sname">Scholarship Name</label>
            <input type="text" name="sname" id="sname" class="form-control" required value="{{ old('sname') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="caste" id="caste" class="form-control" value="{{ old('caste') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="percentage" id="percentage" class="form-control" required value="{{ old('percentage') }}">
        </div>

        <div class="form-group">
            <label for="s_provider">Scholarship Provider</label>
            <input type="text" name="s_provider" id="s_provider" class="form-control" required value="{{ old('s_provider') }}">
        </div>


        <div class="form-group">
            <label for="provider_name">Provider Name</label>
            <input type="text" name="provider_name" id="provider_name" class="form-control" required value="{{ old('provider_name') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="family_income" id="family_income" class="form-control" required value="{{ old('family_income') }}">
        </div>

        <div class="form-group">
            <label for="course_level">Course Level</label>
            <input type="text" name="course_level" id="course_level" class="form-control" required value="{{ old('course_level') }}">
        </div>

        <div class="form-group">
            <label for="course_name">Course Name</label>
            <input type="text" name="course_name" id="course_name" class="form-control" required value="{{ old('course_name') }}">
        </div>

        <div class="form-group">
            <label for="scholarship_link">Scholarship Website Link</label>
            <input type="url" name="Scholarship_link" id="Scholarship_link" class="form-control" required value="{{ old('Scholarship_link') }}" placeholder="https://example.com">
           </div>
