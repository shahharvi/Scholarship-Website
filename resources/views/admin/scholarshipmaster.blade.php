  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="#">
        <input type="text" name="query" placeholder="Search" title="Enter search keyword" style="width: 400px; padding: 8px;">
        <button type="submit" title="Search" style="padding: 8px;"><i class="bi bi-search"></i></button>
      </form>
    </div><!-- End Search Bar -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Scholarships</h1>
       <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ route('admin.scholarship_form') }}">Add</a></li>
              ...
              <table class="table datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $scholarship->provider_name }}</td>
                        <td>{{ $scholarship->start_date }}</td>
                        <td>{{ $scholarship->end_date }}</td>
                        <td>
        <a href="{{ route('admin.scholarship_edit', $scholarship->id) }}" class="btn btn-primary btn-sm">Edit</a>
        <form action="{{ route('admin.scholarship_delete', $scholarship->id) }}" method="POST" style="display:inline-block;">
          @csrf
          @method('DELETE')
